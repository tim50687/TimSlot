...
/*
    19.05.2021
    helper to create paytable help screen
    1) add script to symbols tab
    2) set symbols grid parent
    3) add prefab
    4) add inspector button, set editor and runtime mode. call method Create
 */
namespace Mkey
{
